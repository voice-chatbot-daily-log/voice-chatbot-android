...
public class MainActivity extends AppCompatActivity implements SpeechRecognizeListener,TextToSpeechListener {
    ...
    final String auth_body = "ya29.c.El_8BmhfbvCIRxvueoXcMnDy-CtsiTvO1LZ9Chp53ygAtjSz28YRZRvlE0cBWfZhKbG2h9Q-RwGSywYi3AMhYriyVCJ_S3MLxxbRcNWKOF6AgZ3ukS2Ia-ixyF4eDuEsIg";
        ...
        click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (PermissionUtils.checkAudioRecordPermission(MainActivity.this)) {
                    ...
                    sttClient.setSpeechRecognizeListener(MainActivity.this);
